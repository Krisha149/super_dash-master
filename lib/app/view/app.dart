...
//           home: isTesting
//               ? const MapTesterView()
//               : LoginGate(authenticationRepository: authenticationRepository),
//         ),
//       ),
//     );
//   }
...
import 'package:super_dash/game_intro/game_intro.dart';
import 'package:super_dash/l10n/l10n.dart';
import 'package:super_dash/login/SplashScreen.dart';
import 'package:super_dash/login/login.dart';
import 'package:super_dash/map_tester/map_tester.dart';
import 'package:super_dash/settings/settings.dart';
import 'package:super_dash/share/share.dart';
    ...
    return AppLifecycleObserver(
      child: MultiRepositoryProvider(
        ...
        child: MaterialApp(
          ...
          home: isTesting
              ? const MapTesterView()
              : SplashScreen(authenticationRepository: authenticationRepository), // ✅ Call SplashScreen
        ),
      ),
    );
  }
