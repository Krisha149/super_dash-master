...
import 'package:super_dash/game/widgets/Pause_screen.dart';
            ...
            Row(
              ...
              children: [
                GestureDetector(
                    ...
                    child: Image.asset('assets/images/settings.png',height: 70,width: 70,)),
                GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>PauseDialog()));
                    },
                    child: Image.asset('assets/images/restart.png',height: 70,width: 70,)),
              ],
            ),
            SizedBox(height: 50,),
          ],
